...
const products: IProductInput[] = [
  ...
  {
    name: "nike Men's Running Walking Shoes Fashion Sneakers Mesh Dress Shoes Business Oxfords Shoes  Casual Breathable Work Formal Shoes",
    slug: toSlug(
      "nike Men's Running Walking Shoes Fashion Sneakers Mesh Dress Shoes Business Oxfords Shoes Lightweight Casual Breathable Work Formal Shoes",
    ),
    category: 'Shoes',
    brand: 'ziitop',
    images: ['/images/mojo-02.jpg', '/images/mojo.jpg'],
    tags: ['featured'],
    isPublished: true,
    price: 39.97,
    listPrice: 49.96,
