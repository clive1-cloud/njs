...
// ✅ FIX 1: Provide all schema keys in default values to prevent type inference collapse
...
export default function ReviewList({
  ...
  const { toast } = useToast() // Moved toast initialization to top level safely
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                {/* ✅ FIX 2: Convert standard string select outputs safely to numerical values */}
                                <Select
